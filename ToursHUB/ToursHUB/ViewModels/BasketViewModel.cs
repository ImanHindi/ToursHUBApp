...
namespace ToursHUB.ViewModels
{
    public class BasketViewModel : ViewModelBase
    {
        ...
        public override async Task InitializeAsync(object navigationData)
        {
            ...
            // Update Basket
            var basket = await _basketService.GetBasketAsync(userInfo.Id.ToString(), authToken);
            ...
            MessagingCenter.Unsubscribe<TourCatalogViewModel, CatalogItem>(this, MessageKeys.AddTour);
            MessagingCenter.Subscribe<TourCatalogViewModel, CatalogItem>(this, MessageKeys.AddTour, async (sender, arg) =>
            {
                BadgeCount++;
