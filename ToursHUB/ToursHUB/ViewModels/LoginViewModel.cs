...
namespace ToursHUB.ViewModels
{
    public class LoginViewModel : ViewModelBase
    {
        ...
        public bool IsLocalDb
        {
            ...
            {
                _isLocalDb = value;
                RaisePropertyChanged(() => IsLocalDb);
            }
        }
        ...
        public ICommand LocalDbSignInCommand => new Command(async () => await LocalDbSignInAsync());
        ...
        private async Task LocalDbSignInAsync()
        {
            IsBusy = true;
            IsValid = true;
        ...
        public void InvalidateLocalDb()
        {
           // IsLocalDb = _settingsService.UseLocalDb;
            IsLocalDb = false;
        }
    }
}