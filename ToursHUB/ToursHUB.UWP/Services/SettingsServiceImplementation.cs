...
namespace ToursHUB.Windows.Services
{
    public class SettingsServiceImplementation : ISettingsServiceImplementation
    {
        ...
        public bool AddOrUpdateValue(string key, DateTime value) => AddOrUpdateValueInternal(key, value);
